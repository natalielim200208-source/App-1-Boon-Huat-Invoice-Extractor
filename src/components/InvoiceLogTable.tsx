    ...
    <div className="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden text-slate-900">
      <div className="bg-slate-50 border-b border-slate-200 px-6 py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          {onClearInvoiceLog && (
            <button
              onClick={onClearInvoiceLog}
              className="inline-flex items-center px-3 py-1.5 rounded text-xs font-bold bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 transition shrink-0 uppercase tracking-wider"
              title="Clear all data rows from Invoice Log tab in Google Sheets"
            >
